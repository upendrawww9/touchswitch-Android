...
public class TouchApplication extends MultiDexApplication {

    private static TouchApplication mInstance;
    ...
    public static synchronized TouchApplication getInstance() {
        return mInstance;
    }
