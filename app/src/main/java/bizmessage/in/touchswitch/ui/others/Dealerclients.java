...
public class Dealerclients extends AppCompatActivity implements View.OnClickListener, DialogButtonClickListener {

    private static final String TAG = Dealerclients.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  getSupportActionBar().setTitle("Onlook App Version : "+PreferenceData.getAppVersion());
        ...
        //  Log.d(TAG, "WEBHELP "+WebUtility.WEB_Newcust+PreferenceData.getEmail()+"&pass="+ PreferenceData.getPassword()+"&lat="+PreferenceData.getLatitude()+"&long="+PreferenceData.getLongitude());
       binding.webView.loadUrl(WebUtility.WEB_Newcust+PreferenceData.getEmail()+"&pass="+ PreferenceData.getPassword()+"&lat="+PreferenceData.getLatitude()+"&long="+PreferenceData.getLongitude());
