...
public class Mygroup extends AppCompatActivity implements View.OnClickListener, DialogButtonClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  getSupportActionBar().setTitle("Onlook App Version : "+PreferenceData.getAppVersion());
        ...
        // binding.webView.loadUrl("http://www.google.com");
          Log.d(TAG, "WEBHELP "+WebUtility.WEB_Mygrp);
         binding.webView.loadUrl(WebUtility.WEB_Mygrp+ PreferenceData.getEmail()+"&pass="+PreferenceData.getPassword());
    ...
    public void onBackPressed() {
        Intent intentLanguage = new Intent(Mygroup.this, SettingsActivity.class);
