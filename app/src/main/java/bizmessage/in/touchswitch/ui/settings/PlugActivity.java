...
import bizmessage.in.touchswitch.databinding.ActivityPlugBinding;
...
public class PlugActivity extends AppCompatActivity implements SensorEventListener,View.OnClickListener, TimePickerDialog.OnTimeSetListener, DialogButtonClickListener {

    private static final String TAG = PlugActivity.class.getSimpleName();
    private ActivityPlugBinding binding;
    ...
    String sartttime,endtime,pattern,sartttime2,endtime2,pattern2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_plug);
        setSupportActionBar(binding.toolbar);
      //  getSupportActionBar().setTitle(R.string.title_plug);
        ...
        if(PreferenceData.getlanguage().equalsIgnoreCase("ka")) {
            ...
            binding.btnStatus1.setWidth(200);
            binding.btnStatus2.setWidth(200);
        ...
        if(PreferenceData.getlanguage().equalsIgnoreCase("ta")) {
            ...
            binding.textSwitchTimer2.setTextSize(15);
            binding.textStatusValue.setTextSize(12);
            binding.btnStatus1.setWidth(350);
            binding.btnStatus2.setWidth(350);
        }
        ...
        binding.textControl.setText(resources.getString(R.string.plug_control));///////////////
        binding.textStatus.setText(resources.getString(R.string.plug_status));///////////////
        //binding.textControl.setText(resources.getString(R.string.plug_control));///////////////


        binding.textTimeOn1.setText(resources.getString(R.string.plug_ontime));///////////////
        binding.textTimeOff1.setText(resources.getString(R.string.plug_offtime));///////////////
        binding.textTimeOn2.setText(resources.getString(R.string.plug_ontime));///////////////
        binding.textTimeOff2.setText(resources.getString(R.string.plug_offtime));///////////////
        binding.textStatus.setText(resources.getString(R.string.plug_status));///////////////
        Utility.showToast(resources.getString(R.string.please_wait));
        getSupportActionBar().setTitle(resources.getString(R.string.title_plug_one)); // title setting here

        // Utility.showToast(OnlookApplication.SELECTED_DEVICE.getisHooter());
        if(OnlookApplication.SELECTED_DEVICE.getisHooter().equalsIgnoreCase("true")) {
         binding.textControl.setText(resources.getString(R.string.siren_control));///////////////
           binding.textStatus.setText(resources.getString(R.string.siren_status));///////////////
            ...
            binding.cardSwitchTimer2.setVisibility(View.GONE);
             ...
             binding.textControl.setText(resources.getString(R.string.plug_control));///////////////
        binding.textStatus.setText(resources.getString(R.string.plug_status));///////////////
            binding.cardSwitchTimer1.setVisibility(View.VISIBLE);
            binding.cardSwitchTimer2.setVisibility(View.VISIBLE);


         }


        if (OnlookApplication.SELECTED_DEVICE.getRIsPlug().equalsIgnoreCase("false")) {
        ...
        if(OnlookApplication.SELECTED_DEVICE.getisHooter().equalsIgnoreCase("true")) {
             binding.imgSwitchBulb.setImageDrawable(getResources().getDrawable(R.drawable.siren));
...
/*            binding.ViewForegroundDark.setVisibility(View.VISIBLE);
    ...
    private void setupMqttConnection() {
        ...
        mqttAndroidClient.setCallback(new MqttCallbackExtended() {
            ...
            public void connectComplete(boolean reconnect, String serverURI) {
                if (reconnect) {
                    subscriptionTopic = "stat/" + OnlookApplication.SELECTED_DEVICE.getDevid() + "/POWER1";
                    subscribeToTopic(subscriptionTopic);
                    try {
                        publishMessage("cmnd/" + OnlookApplication.SELECTED_DEVICE.getDevid() + "/POWER1", "");
            ...
            public void messageArrived(String topic, MqttMessage message) throws Exception {
                ...
                if(!OnlookApplication.SELECTED_DEVICE.getLwt().equalsIgnoreCase("Online")){
                    ...
                    Intent intent = new Intent(PlugActivity.this, MainActivity.class);
    ...
    private void setTimeValue(SwitchSettingResponse settingResponse,boolean isFirstTime) {
        ...
        if (activeTime1.equalsIgnoreCase("1")) {
           //binding.btnStatus1.setText("DEACTIVATE");
            binding.btnStatus1.setText(resources.getString(R.string.plug_deactivate));/////////////
           ...
           binding.textSwitchTimer1.setTextColor(Color.parseColor("#FF358500"));
            ...
            binding.textSwitchTimer1.setText(resources.getString(R.string.plug_remote_timer1running));///////////////
           ...
           // binding.btnStatus1.setText("ACTIVE");
            binding.btnStatus1.setText(resources.getString(R.string.plug_activate));/////////////
           ...
           // binding.textSwitchTimer1.setText("Remote Timer1 - Stopped");
            binding.textSwitchTimer1.setText(resources.getString(R.string.plug_remote_timer1stopped));///////////////
        }
        ...
        if (activeTime2.equalsIgnoreCase("1")) {
            ...
            binding.btnStatus2.setText(resources.getString(R.string.plug_deactivate));/////////////
           ...
           // binding.textSwitchTimer2.setText("Remote Timer2- Running");
            binding.textSwitchTimer2.setText(resources.getString(R.string.plug_remote_timer2running));///////////////
        } else {
            binding.textTimeOnValue2.setEnabled(true);
            binding.textTimeOffValue2.setEnabled(true);
            binding.textTimeStatus2.setText("");
          //  binding.btnStatus2.setText("ACTIVE");
            binding.btnStatus2.setText(resources.getString(R.string.plug_activate));/////////////
           ...
           // binding.textSwitchTimer2.setText("Remote Timer2 - Stopped");
            binding.textSwitchTimer2.setText(resources.getString(R.string.plug_remote_timer2stopped));///////////////
        }
    ...
    private void setLightOff() {
        ...
        binding.textStatusValue.setText(resources.getString(R.string.plug_off));

        if(OnlookApplication.SELECTED_DEVICE.getisHooter().equalsIgnoreCase("true")) {
             binding.textStatusValue.setText(resources.getString(R.string.plug_off));
            PreferenceData.setisSirenon(false);
            binding.cardSwitchTimer3.setCardBackgroundColor(getResources().getColor(R.color.card_view_gb));
            binding.imgSwitchBulb.setImageDrawable(getResources().getDrawable(R.drawable.siren));
         ...
         //   binding.textControl.setText(resources.getString(R.string.plug_control));///////////////
          //  binding.textStatus.setText(resources.getString(R.string.plug_status));///////////////
            binding.imgSwitchBulb.setImageDrawable(getResources().getDrawable(R.drawable.ic_bulb_off));
        ...
        binding.textStatusValue.setTextColor(Color.RED);
        if (isOffLine) {
    ...
    private void updateSwitchStatus(boolean isSwitchOn) {
     //   Utility.showProgress(PlugActivity.this);
        if(DBG) Log.i(TAG, "updateSwitchStatus: IS SWITCH -" + isSwitchOn);
        if (isSwitchOn) {
            publishMessage("cmnd/" + OnlookApplication.SELECTED_DEVICE.getDevid() + "/POWER1", "ON");
        } else {
            publishMessage("cmnd/" + OnlookApplication.SELECTED_DEVICE.getDevid() + "/POWER1", "OFF");
        }
    }
    ...
    private void setLightOn() {
        if(OnlookApplication.SELECTED_DEVICE.getisHooter().equalsIgnoreCase("true")) {
                ...
                toneGen1 = new ToneGenerator(AudioManager.STREAM_DTMF, 100);
                toneGen1.startTone(ToneGenerator.TONE_CDMA_EMERGENCY_RINGBACK, 500);



            PreferenceData.setisSirenon(true);
            binding.cardSwitchTimer3.setCardBackgroundColor(Color.parseColor("#f1c70623"));
       ...
       // binding.textStatusValue.setText(R.string.light_on);
        binding.textStatusValue.setText(resources.getString(R.string.plug_on));
        ...
        if(OnlookApplication.SELECTED_DEVICE.getisHooter().equalsIgnoreCase("true")) {
            //   binding.textControl.setText(resources.getString(R.string.siren_control));///////////////
            //   binding.textStatus.setText(resources.getString(R.string.siren_status));///////////////
            binding.imgSwitchBulb.setImageDrawable(getResources().getDrawable(R.drawable.sirenon2));

        }
        else{
            //   binding.textControl.setText(resources.getString(R.string.plug_control));///////////////
            //  binding.textStatus.setText(resources.getString(R.string.plug_status));///////////////
            binding.imgSwitchBulb.setImageDrawable(getResources().getDrawable(R.drawable.ic_bulb_on));
            ...
            case R.id.btnStatus1:
                ...
                if (!isOffLine){
                    if (activeTime1.equalsIgnoreCase("1")) {
                        ...
                        if (!isValidOnTime()) {
                            Utility.showSnackBar(binding.btnStatus2, resources.getString(R.string.valid_plug_on_time));
                        } else if (!isValidOffTime()) {
                            Utility.showSnackBar(binding.btnStatus2, resources.getString(R.string.valid_plug_off_time));
                        } else {
                            activeTime1 = "1";
                            ///////////////
                            try {
                    ...
                    if (activeTime2.equalsIgnoreCase("1")) {
                        ...
                        if (!isValidOnTime2()) {
                            ...
                            try {
                                ...
                                pattern2 = "HH:mm:00";
                                sdf2 = new SimpleDateFormat(pattern2);


                                Date date3 = sdf2.parse(sartttime2);
                                Date date4 = sdf2.parse(endtime2);
    ...
    protected void onResume() {
        super.onResume();
        Utility.hideProgress();
        checkConnection(PlugActivity.this,this);
        getSetting(true);
        sensorManager.registerListener(this, accelerometer, SensorManager.SENSOR_DELAY_NORMAL);
    }
    @Override
...
//binding.textDeviceId.setText("x"+lastX+"||| y :"+lastY+" ||| z:"+lastZ   );
    ...
    private void setTimer(String activate, int isFrom) {
        if (!Utility.isNetworkAvailable(PlugActivity.this)) {
            ...
            if (isFrom == 1) {
                responseCall = service.setPlug(activate, WebUtility.SET_PLUG1_OPS, onHourTime1, onMinuteTime1, offHourTime1, offMinuteTime1, OnlookApplication.SELECTED_DEVICE.getDevid());
            }  if (isFrom == 2) {
                responseCall = service.setPlug(activate, WebUtility.SET_PLUG2_OPS, onHourTime2, onMinuteTime2, offHourTime2, offMinuteTime2, OnlookApplication.SELECTED_DEVICE.getDevid());
            }
            if (isFrom == 3) { // this is setSwitch only for light on and off capture///////
                responseCall = service.setSwitch(activate, WebUtility.SET_PLUG_ONOFF, "x", "x", "x", "x", OnlookApplication.SELECTED_DEVICE.getDevid());
            }
    ...
    private void getSetting(boolean isShowProgress) {
        if (!Utility.isNetworkAvailable(PlugActivity.this)) {
            ...
            WebServiceCaller.ApiInterface service = WebServiceCaller.getClient();
            Call<SwitchSettingResponse> responseCall = service.getPlugSettings("no", OnlookApplication.SELECTED_DEVICE.getDevid());
    ...
    private void selectTime() {
        ...
        mTimePicker = new TimePickerDialog(PlugActivity.this, R.style.TimePickerTheme, this, hour, minute, true);
