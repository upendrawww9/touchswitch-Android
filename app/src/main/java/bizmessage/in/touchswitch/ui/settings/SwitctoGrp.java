...
public class SwitctoGrp extends AppCompatActivity implements View.OnClickListener, DialogButtonClickListener {

    private static final String TAG = SwitctoGrp.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  getSupportActionBar().setTitle("Onlook App Version : "+PreferenceData.getAppVersion());
        ...
        // binding.webView.loadUrl("http://www.google.com");
          Log.d(TAG, "WEBHELP "+WebUtility.WEB_Swtogrp);
        binding.webView.loadUrl(WebUtility.WEB_Swtogrp+ PreferenceData.getEmail()+"&pass="+PreferenceData.getPassword());
