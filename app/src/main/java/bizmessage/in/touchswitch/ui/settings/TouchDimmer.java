...
import bizmessage.in.touchswitch.databinding.ActivityTouchdimmerBinding;
...
public class TouchDimmer extends AppCompatActivity implements SensorEventListener ,View.OnClickListener, DialogButtonClickListener {

    private static final String TAG = TouchDimmer.class.getSimpleName();
    private ActivityTouchdimmerBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_touchdimmer);
...
//        binding.imgSwitch.setVisibility(View.GONE);
 ...
 if(inboundvalue.contains("ON")||inboundvalue.contains("OFF")) {
     if (!TouchApplication.SELECTED_DEVICE.getLwt().equalsIgnoreCase("Online")) {
         ...
         Intent intent = new Intent(TouchDimmer.this, MainActivity.class);
...
PreferenceData.setisLighton(true);
   ...
   //     binding.textStatusValue.setText(R.string.light_on);
    ...
    private void setTimer(String activate, int isFrom) {
        if (!Utility.isNetworkAvailable(TouchDimmer.this)) {
...
//LightTwoActivity
 ...
 //                       Utility.showSnackBar(binding.btnStatus1, resources.getString(R.string.status_updated_successfully));
    ...
    protected void onResume() {
        super.onResume();
        Utility.hideProgress();
        checkConnection(TouchDimmer.this,this);
        getSetting(true);
        sensorManager.registerListener(this, accelerometer, SensorManager.SENSOR_DELAY_NORMAL);
    }
    @Override
