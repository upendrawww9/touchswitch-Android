...
import bizmessage.in.touchswitch.databinding.ActivityFirsttimeHotspotBinding;
...
public class FirstTimeHotSpotActivity extends AppCompatActivity implements View.OnClickListener, DialogButtonClickListener {

    private static final String TAG = FirstTimeHotSpotActivity.class.getSimpleName();
    public static String[] wifiname;
    private ActivityFirsttimeHotspotBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_firsttime_hotspot);
...
//
    private void updateSettings(String isFamily, String wifiName, String status, boolean isChecked,String password) {
        if (!Utility.isNetworkAvailable(FirstTimeHotSpotActivity.this)) {
            Utility.showSnackBar(binding.appBarLayout, getString(R.string.no_internet_connection));
        } else {
            Utility.showProgress(FirstTimeHotSpotActivity.this);
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Ok", (dialog, id) -> {
                    ...
                    if (x==1) {
                           ...
                           //     binding.btnSubmit.setBackgroundColor(Color.GRAY);
                            ...
                            public void onFinish() {
                             //   binding.textWifiStatus.setText("done!");
                                Intent intent = new Intent(FirstTimeHotSpotActivity.this, MainActivity.class);
                        ...
                        Intent intent = new Intent(FirstTimeHotSpotActivity.this, LoginActivity.class);
                        startActivity(intent);
                        finish();
                        overridePendingTransition(0,0);
                    }
