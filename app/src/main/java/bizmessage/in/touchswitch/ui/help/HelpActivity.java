package bizmessage.in.touchswitch.ui.help;
...
public class HelpActivity extends AppCompatActivity implements View.OnClickListener, DialogButtonClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  getSupportActionBar().setTitle("Onlook App Version : "+PreferenceData.getAppVersion());
        ...
        // binding.webView.loadUrl("http://www.google.com");
          Log.d(TAG, "WEBHELP "+WebUtility.WEB_HELP);
       binding.webView.loadUrl(WebUtility.WEB_HELP);
